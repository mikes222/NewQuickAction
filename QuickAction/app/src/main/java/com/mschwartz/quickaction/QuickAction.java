 ...
 */
public class QuickAction<T extends Object> extends PopupWindows implements OnDismissListener {
	...
	public void addActionItem(final ActionItem actionItem) {
		...
		if (actionItem.getIcon() != null) {
			img.setImageDrawable(actionItem.getIcon());
		} else {
			img.setVisibility(View.GONE);
		}
		
		if (actionItem.getTitle() != null) {
			text.setText(actionItem.getTitle());
		} else {
